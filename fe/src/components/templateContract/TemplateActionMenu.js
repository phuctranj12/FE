...
function TemplateActionMenu({ template, isShared = false, onEdit, onBatchCreate, onSingleCreate, onStopPublish, onShare, onCopy, onCreateWithFlow, onDelete }) {
    ...
    const handleAction = (action, e) => {
        ...
        const handlers = {
            edit: onEdit,
            batchCreate: onBatchCreate,
            singleCreate: onSingleCreate,
            stopPublish: onStopPublish,
            share: onShare,
            copy: onCopy,
            createWithFlow: onCreateWithFlow,
            delete: onDelete
        };
                ...
                <div className="action-dropdown">
                    {!isShared && (
                        <>
                            ...
                            <button className="action-item pause-item" onClick={(e) => handleAction('stopPublish', e)}>
                                <svg className="action-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0B57D0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <rect x="6" y="4" width="4" height="16"></rect>
                                    <rect x="14" y="4" width="4" height="16"></rect>
                                </svg>
                                <span>Ngừng phát hành</span>
                            </button>
                    ...
                    <button className="action-item batch-item" onClick={(e) => handleAction('batchCreate', e)}>
                        <svg className="action-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0B57D0" strokeWidth="2" strokeLinecap=" líderround" strokeLinejoin="round">
                        ...
                        <span>Tạo tài liệu theo lô</span>
                    </button>
                    ...
                    <button className="action-item flow-item" onClick={(e) => handleAction('createWithFlow', e)}>
                        <svg className="action-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0B57D0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                            <polyline points="14 2 14 8 20 8"></polyline>
