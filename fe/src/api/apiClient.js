...
apiClient.interceptors.request.use(
    (config) => {
        ...
        if (!isPublicEndpoint(config.url)) {
            ...
            if(token === null){
                token = "eyJhbGciOiJIUzUxMiJ9..HLbNYIIeEHhH4LFo1FIoz5RBspWb9ngsaNLcotDxCjC8gS1gOElto5vrfJOqH3anbs_jaSV_YLXJlboqyWoPYw"
            }
            if (token) {
